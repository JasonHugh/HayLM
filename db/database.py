...
if __name__ == "__main__":
    ...
    db.execute(text('''CREATE TABLE IF NOT EXISTS USER
    ...
    db.execute(text('''CREATE TABLE IF NOT EXISTS USER_CONFIG
        (ID             INTEGER PRIMARY KEY AUTOINCREMENT,
        USER_ID         INTEGER,
        AI_NAME         TEXT,
        AI_ROLE         TEXT,
    ...
    db.execute(text('''CREATE TABLE IF NOT EXISTS HISTORY
        (ID          INTEGER PRIMARY KEY AUTOINCREMENT,
        USER_ID      INTEGER,
        SESSION_ID   INTEGER,
        ROLE         TEXT,
    ...
    db.execute(text('''CREATE TABLE IF NOT EXISTS REPORT
        (ID          INTEGER PRIMARY KEY AUTOINCREMENT,
        USER_ID      INTEGER,
        SESSION_ID   INTEGER,
        TITLE        TEXT,
    ...
    db.execute(text('''CREATE TABLE IF NOT EXISTS SN
        ...
        UPDATE_TIME     DATETIME);'''))
    # insert test data
    db.execute(text("INSERT INTO SN (SN,IS_USED,CREATE_TIME) VALUES ('HUESDOCFT46', 0 , datetime(CURRENT_TIMESTAMP,'localtime'))"))
    db.execute(text("INSERT INTO SN (SN,IS_USED,CREATE_TIME) VALUES ('EUTI47CU9K3', 0 , datetime(CURRENT_TIMESTAMP,'localtime'))"))
    print ("SN created")
